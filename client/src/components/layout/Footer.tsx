...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-400 py-12 px-4 md:px-6">
      <Glassmorphism className="px-6 py-10">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} basics-AI. All rights reserved.</p>
        </div>
      </Glassmorphism>
    </footer>
  );
